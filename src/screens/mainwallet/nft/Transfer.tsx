    ...
    return (
        <View style={styles.container}>
            <View style={styles.contentContainer}>
                ...
                <Text style={[styles.title,{ fontSize: Responsive.size28}]} numberOfLines={1}>{strings.transfer + ' ' + strings.incription}</Text>
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emprtyViewStyle}>
                            <Text style={styles.emprtyViewText}>{strings.noBrc20incriptions}</Text>
                        </View>
                    }
                />
