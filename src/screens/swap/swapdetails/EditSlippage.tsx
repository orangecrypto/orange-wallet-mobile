...
const EditSlippage = ({ route, navigation }) => {
    ...
    const handleInputChange = (text: string) => {
        ...
        if (parsed <= maxSlippage) {
            ...
            setIsError(true);
            setErrorMessage(`${strings.maxSlippageMessage} ${maxSlippage}`); 
            setIsButtonDisabled(true); 
        }
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.contentContainer}>
                ...
                <Text style={[styles.title, { marginTop: Responsive.size40 }]}>{strings.editSlippage}</Text>
            ...
            {!isKeyboardVisible && (
                <View style={styles.buttonContainer}>
                    <CommonButton
                        ...
                        disabled={isButtonDisabled || Number(value) <= 0} 
                    />
                </View>
            )}
        </View>
